...
/**
 * Direct Group Manager
 * Uses direct axios calls to Pinata API to avoid IPFS service issues
 */
export class DirectGroupManager {
  private static instance: DirectGroupManager;

  private constructor() {}

  public static getInstance(): DirectGroupManager {
    if (!DirectGroupManager.instance) {
      DirectGroupManager.instance = new DirectGroupManager();
    }
    return DirectGroupManager.instance;
  }
  ...
  /**
   * Upload harvest certificate directly to Pinata
   */
  ...
  /**
   * Upload purchase certificate directly to Pinata
   */
...
export const directGroupManager = DirectGroupManager.getInstance();
