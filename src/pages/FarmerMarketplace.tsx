    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p>Loading farmer marketplace...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-600">Buy fresh produce directly from farmers</p>
          </div>
        </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">
                  {new Set(filteredBatches.map(b => b.farmer_id)).size}
                </p>
              </div>
            </div>
          </CardContent>
      ...
      {filteredBatches.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500">
            {searchTerm ? 'Try adjusting your search terms' : 'No batches available at the moment'}
          </p>
        </div>
      )}
